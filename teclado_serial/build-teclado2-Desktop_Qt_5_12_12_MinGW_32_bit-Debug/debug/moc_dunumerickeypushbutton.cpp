...
#include "../../teclado2/dunumerickeypushbutton.h"
...
void DuNumericKeyPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DuNumericKeyPushButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (DuNumericKeyPushButton::*)(QString );
...
QT_INIT_METAOBJECT const QMetaObject DuNumericKeyPushButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_DuNumericKeyPushButton.data,
    qt_meta_data_DuNumericKeyPushButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
